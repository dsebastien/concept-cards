...
describe('animation variants', () => {
    describe('pageVariants', () => {
        ...
        test('initial state has opacity 0', () => {
            expect((pageVariants['initial'] as Record<string, unknown>)['opacity']).toBe(0)
        })

        test('animate state has opacity 1', () => {
            expect((pageVariants['animate'] as Record<string, unknown>)['opacity']).toBe(1)
        })
    })
    ...
    describe('fadeInVariants', () => {
        ...
        test('initial opacity is 0', () => {
            expect((fadeInVariants['initial'] as Record<string, unknown>)['opacity']).toBe(0)
        })

        test('animate opacity is 1', () => {
            expect((fadeInVariants['animate'] as Record<string, unknown>)['opacity']).toBe(1)
        })
    })
    ...
    describe('fadeInUpVariants', () => {
        ...
        test('initial state has y offset', () => {
            expect((fadeInUpVariants['initial'] as Record<string, unknown>)['y']).toBe(30)
        })

        test('animate state has y at 0', () => {
            expect((fadeInUpVariants['animate'] as Record<string, unknown>)['y']).toBe(0)
        })
    })
    ...
    describe('staggerContainerVariants', () => {
        ...
        test('animate has stagger transition', () => {
            const animate = staggerContainerVariants['animate'] as Record<string, unknown>
    ...
    describe('scaleFadeVariants', () => {
        ...
        test('initial state has scaled down effect', () => {
            const initial = scaleFadeVariants['initial'] as Record<string, unknown>
            expect(initial['scale']).toBe(0.95)
            expect(initial['opacity']).toBe(0)
        })
    })
    ...
    describe('backdropVariants', () => {
        ...
        test('animates opacity only', () => {
            expect((backdropVariants['initial'] as Record<string, unknown>)['opacity']).toBe(0)
            expect((backdropVariants['animate'] as Record<string, unknown>)['opacity']).toBe(1)
            expect((backdropVariants['exit'] as Record<string, unknown>)['opacity']).toBe(0)
        })
    })
    ...
    describe('slideInRightVariants', () => {
        ...
        test('initial state is off-screen to the right', () => {
            expect((slideInRightVariants['initial'] as Record<string, unknown>)['x']).toBe('100%')
        })

        test('animate state is at normal position', () => {
            expect((slideInRightVariants['animate'] as Record<string, unknown>)['x']).toBe(0)
        })
    })
    ...
    describe('progressVariants', () => {
        ...
        test('initial width is 0', () => {
            expect((progressVariants['initial'] as Record<string, unknown>)['width']).toBe(0)
        })

        test('animate is a function that takes width parameter', () => {
            expect(typeof progressVariants['animate']).toBe('function')
            const animateFn = progressVariants['animate'] as (
                width: number
            ) => Record<string, unknown>
            const result = animateFn(50)
    ...
    describe('statsVariants', () => {
        ...
        test('initial state is scaled down', () => {
            expect((statsVariants['initial'] as Record<string, unknown>)['scale']).toBe(0.5)
        })

        test('uses custom easing (back ease out)', () => {
            const animate = statsVariants['animate'] as Record<string, unknown>
            const transition = animate['transition'] as Record<string, unknown>
    ...
    describe('heroVariants', () => {
        ...
        test('has larger y offset than fadeInUp', () => {
            expect((heroVariants['initial'] as Record<string, unknown>)['y']).toBe(40)
        })
    })
